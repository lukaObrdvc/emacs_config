...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-constant-face ((,class (:foreground ,jazz-fg))))
   `(font-lock-doc-face ((,class (:foreground ,jazz-green+1))))
   `(font-lock-doc-string-face ((,class (:foreground ,jazz-blue+1))))
   `(font-lock-function-name-face ((,class (:foreground ,jazz-fg))))
   `(font-lock-keyword-face ((,class (:foreground ,jazz-orange))))
   `(font-lock-negation-char-face ((,class (:foreground ,jazz-fg))))
   `(font-lock-preprocessor-face ((,class (:foreground ,jazz-orange))))
   `(font-lock-string-face ((,class (:foreground ,jazz-red))))
   `(font-lock-type-face ((,class (:foreground ,jazz-yellow))))
   `(font-lock-variable-name-face ((,class (:foreground ,jazz-fg))))
